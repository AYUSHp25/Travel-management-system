...
public class Loading extends JFrame implements Runnable {
	...
	public Loading(String username) {
            ...
            contentPane.setBackground(new Color(145,204, 100));
            setContentPane(contentPane);
            contentPane.setLayout(null);

            JLabel lbllibraryManagement = new JLabel("Travel Application");
            lbllibraryManagement.setForeground(new Color(100, 145, 70));
